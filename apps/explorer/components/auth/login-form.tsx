    ...
    <Panel title="Login">
      <div className="flex flex-col gap-4">
        <div className="text-center">
          <h2 className="text-base font-mono text-bone-base">Welcome back</h2>
          <p className="text-xs font-mono text-bone-muted">Sign in to your account to continue</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-1">
          ...
          <div>
            <div className="flex justify-between mb-1">
              <span className="text-xs font-mono text-bone-dim">Password</span>
              <Link href="/forgot-password" className="text-xs font-mono text-bone-ghost no-underline hover:text-bone-base transition-colors">
                Forgot password?
              </Link>
            </div>
            <FormInput
        ...
        <p className="text-center text-xs font-mono text-bone-ghost">
          ...
          <Link href="/register" className="text-bone-dim no-underline hover:text-bone-base transition-colors">Sign up</Link>
        </p>
      </div>
    </Panel>
  );
