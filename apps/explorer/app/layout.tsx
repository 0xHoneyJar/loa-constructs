...
export const metadata: Metadata = {
  ...
  description: 'Named expertise for AI coding agents. Install a construct — your agent sees problems differently.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Constructs Network — Named expertise for AI coding agents',
      },
    ],
  },
  twitter: {
