  ...
  return (
    <div className="group relative">
      <pre className="overflow-x-auto border border-void-border bg-void-raised p-4">
        <code className="font-mono text-lg text-bone-base">{children}</code>
      </pre>
    </div>
  );
}
  ...
  return (
    <div>
      <div className="mb-3 flex items-center gap-3">
        ...
        <h3 className="font-mono text-lg font-medium text-bone-base">{title}</h3>
      </div>
      {children}
    </div>
  );
...
export default function InstallPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <Link
        href="/"
        className="mb-8 inline-flex items-center gap-2 font-mono text-base text-bone-ghost transition-colors hover:text-bone-bright"
      >
        ← Back
      </Link>
      ...
      <section className="mb-12">
        <h2 className="mb-4 font-mono text-base font-semibold uppercase tracking-wider text-bone-ghost">
          With the CLI
        </h2>
        ...
        <div className="space-y-8">
          <Step number={1} title="Browse what's available">
            ...
            <p className="mt-2 text-base text-bone-ghost">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-3">
          ...
          <p className="text-base text-bone-ghost">
  ...
  --template 0xHoneyJar/construct-base --clone`}</CodeBlock>
      ...
      <section className="mb-12">
        ...
        <p className="mt-3 text-base text-bone-ghost">
