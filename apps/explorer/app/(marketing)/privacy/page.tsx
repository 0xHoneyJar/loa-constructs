...
export default function PrivacyPage() {
  return (
    <div className="space-y-6 max-w-3xl">
      <h1 className="text-2xl font-mono font-bold text-bone-base">Privacy Policy</h1>
      ...
      <div className="space-y-6 text-xs font-mono text-bone-dim leading-relaxed">
        <section>
          <h2 className="text-sm text-bone-base font-bold mb-2">1. Information We Collect</h2>
          <p>
        ...
        <section>
          <h2 className="text-sm text-bone-base font-bold mb-2">2. How We Use Information</h2>
          <p>
        ...
        <section>
          <h2 className="text-sm text-bone-base font-bold mb-2">3. Data Storage</h2>
          <p>
        ...
        <section>
          <h2 className="text-sm text-bone-base font-bold mb-2">4. Data Sharing</h2>
          <p>
        ...
        <section>
          <h2 className="text-sm text-bone-base font-bold mb-2">5. Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-sm text-bone-base font-bold mb-2">6. Your Rights</h2>
          <p>
        ...
        <section>
          <h2 className="text-sm text-bone-base font-bold mb-2">7. Changes to Policy</h2>
          <p>
