...
export async function submitFeedback(data: FeedbackData) {
  ...
  // In explorer, signals endpoint is local
  const endpoint = process.env.SIGNALS_ENDPOINT || `${process.env.NEXT_PUBLIC_SITE_URL || 'https://constructs.network'}/api/signals`;
