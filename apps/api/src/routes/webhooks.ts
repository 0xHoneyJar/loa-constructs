    ...
    return c.json({
      data: {
        ...
        instructions: [
          ...
          `4. Set Secret to the value in the "secret" field above (do not log or share this value)`,
          `5. Select events: "Just the push event" (or add "Create" for tag events)`,
          `6. Set GITHUB_WEBHOOK_SECRET environment variable on the API server to the same secret value`,
          `7. Click "Add webhook"`,
        ],
      },
