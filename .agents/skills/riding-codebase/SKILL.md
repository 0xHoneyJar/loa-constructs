...
### 3.2 Assess AI Guidance Quality (AGENTS.md)

Score existing AGENTS.md on: length (>50 lines), tech stack mentions, pattern/convention guidance, warnings. Score out of 7; below 5 is insufficient.
