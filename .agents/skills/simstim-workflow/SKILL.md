...
**External providers called**: Codex Opus 4.7 (primary), GPT-5.3-codex (cross-review), Gemini 2.5 Pro (tertiary)
...
This skill manages its own 8-phase workflow. DO NOT use Codex's native Plan Mode.
...
If Codex session times out and user returns to a new session:
