---
name: "source-command-feedback"
description: "Submit developer feedback about Loa experience with optional execution traces.
...
Use this skill when the user asks to run the migrated source command `feedback`.
