---
name: "source-command-update-loa"
description: "Pull latest Loa framework updates from upstream repository.
Fetches, previews, confirms, and merges with conflict guidance.
Supports WIP branch testing with checkout option."
---

# source-command-update-loa

Use this skill when the user asks to run the migrated source command `update-loa`.
...
>
> **Fixes**: [#554](https://github.com/0xHoneyJar/loa/issues/554) — `.loa-version.json` + `Codex.loa.md` markers not refreshed by `/update-loa` merge resolution.
...
- Check `AGENTS.md` for new commands or workflow updates
