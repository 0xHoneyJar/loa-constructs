---
name: "source-command-propose-learning"
description: "Propose an eligible learning for upstream contribution to Loa framework"
---

# source-command-propose-learning

Use this skill when the user asks to run the migrated source command `propose-learning`.
