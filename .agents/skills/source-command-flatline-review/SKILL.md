---
name: "source-command-flatline-review"
description: "Manual invocation of Flatline Protocol for adversarial multi-model review.
...
# source-command-flatline-review

Use this skill when the user asks to run the migrated source command `flatline-review`.
