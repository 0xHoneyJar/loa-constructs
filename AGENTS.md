...
1. Codex loads `@.claude/loa/CLAUDE.loa.md` first (framework instructions)
2. Then loads this file (project-specific instructions)
3. Instructions in this file **take precedence** over imported content
4. Framework updates modify `.Codex/loa/Codex.loa.md`, not this file
...
| `.Codex/constructs/packs/` | Gitignored runtime installation | Read-only (generated) |
| `.Codex/` | System zone (framework-managed) | Never edit directly |
