...
Constructs chain through **typed streams** — [Unix philosophy](https://en.wikipedia.org/wiki/Unix_philosophy) over LLM expertise. Five primitive stream types flow between stages:
