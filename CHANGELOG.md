...
## [2.25.0] — 2026-04-22 — Open Playground — transparency + determinism + starter OS + trichotomy + first workflow

## Cycle-004 close — Open Playground

### Added

- **cycle-004 L5**: feel-audit workflow — first runnable workflow-kind composition
- **cycle-004 L2**: invocation contract — deterministic dispatch across 12/14 forms
- **cycle-004 L1**: constructs-active.sh — agent active-context reporter
